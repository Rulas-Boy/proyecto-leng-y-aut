...
class test implements testConstants {
  ...
  static final public void Iniciar() throws ParseException {
    ...
    jj_consume_token(Absoluto);
    jj_consume_token(Abstracto);
    jj_consume_token(Activar);
    jj_consume_token(Alias);
    jj_consume_token(Y);
    jj_consume_token(Aplicacion);
    jj_consume_token(Arreglo);
    jj_consume_token(Ascendiente);
    jj_consume_token(Ensamblador);
    jj_consume_token(Afirmar);
    jj_consume_token(0);
  }
